...
export function AppLogo({ className, ...rest }: SVGAttributes<SVGSVGElement>) {
    return (
        <ViewTransition name={APP_LOGO_VT_NAME} share="vt-logo-share">
            <svg className={classNames("fill-none stroke-current", className)} viewBox="0 0 64 64" strokeWidth={3} strokeLinecap="round" strokeLinejoin="round" aria-label="Mermaid Out logo" {...rest}>
...
export const APP_LOGO_VT_NAME = "mo-app-logo";

export const APP_NAME = "Mermaid Out";
